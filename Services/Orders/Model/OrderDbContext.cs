...
namespace Orders.Model
{
    public class OrderDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) 
        {
            ...
            modelBuilder.Entity<Order>().Property<OrdersCurrency>(x => x.BaseCurrency).HasColumnName("basecurrency");
            modelBuilder.Entity<Order>().Property<OrdersCurrency>(x => x.QuoteCurrency).HasColumnName("quotecurrency");
